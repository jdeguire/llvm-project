...
entry:
  ...
  ret void
; CHECK: 	.ent	foo1
; CHECK: 	save	$16, $17, $ra, [[FS:[0-9]+]]  # <MCInst #{{[0-9]+}} Save16
; CHECK: 	restore	$16, $17, $ra, [[FS]]   # <MCInst #{{[0-9]+}} Restore16
; CHECK: 	.end	foo1
}
...
entry:
  ...
  ret void
; CHECK: 	.ent	foo2
; CHECK: 	save	$16, $17, $ra, [[FS:[0-9]+]]  # <MCInst #{{[0-9]+}} SaveX16
; CHECK: 	restore	$16, $17, $ra, [[FS]]   # <MCInst #{{[0-9]+}} RestoreX16
; CHECK: 	.end	foo2
}
...
entry:
  ...
  ret void
; CHECK: 	.ent	foo3
; CHECK: 	save	$16, $17, $18, $ra, [[FS:[0-9]+]]   # <MCInst #{{[0-9]+}} SaveX16
; CHECK: 	restore	$16, $17, $18, $ra, [[FS]]    # <MCInst #{{[0-9]+}} RestoreX16
; CHECK: 	.end	foo3
}
