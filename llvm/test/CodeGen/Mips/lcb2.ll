...
; lcb: 	.ent	bnez
; lcb:	bnez	${{[0-9]+}}, $BB{{[0-9]+}}_{{[0-9]+}}       # <MCInst #{{[0-9]+}} BnezRxImmX16
; lcb: 	.end	bnez
...
; lcb: 	.ent	beqz
; lcb:	beqz	${{[0-9]+}}, $BB{{[0-9]+}}_{{[0-9]+}}       # <MCInst #{{[0-9]+}} BeqzRxImmX16
; lcb: 	.end	beqz
...
; lcb: 	.ent	bteqz
; lcb:	btnez	$BB{{[0-9]+}}_{{[0-9]+}}                  # <MCInst #{{[0-9]+}} BtnezX16
; lcb: 	.end	bteqz
...
; lcb: 	.ent	btz
; lcb:	bteqz	$BB{{[0-9]+}}_{{[0-9]+}}                  # <MCInst #{{[0-9]+}} BteqzX16
; lcb:	btnez	$BB{{[0-9]+}}_{{[0-9]+}}                  # <MCInst #{{[0-9]+}} BtnezX16
; lcb: 	.end	btz
